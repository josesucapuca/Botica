...
if ($opcion === "ListarEmpleadoById") {

    $EmpId = $_POST["id"];
    $consultda = "call ListaEmpleadoById($EmpId);";
    $var = mysqli_query($conexion, $consultda);
    $arr = array();
    if (mysqli_num_rows($var) != 0) {
        while ($row = mysqli_fetch_assoc($var)) {
