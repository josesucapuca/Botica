        ...
        <div class="d-flex">
            <div class="sidebar sidebar-dark bg-dark" style="position: -webkit-sticky;position: sticky;top: 0;">
                ...
                <ul class="list-unstyled">
                    <li><a href="Principal.php"><i class="fa fa-fw fa-tachometer-alt"></i> Pagina de Inicio</a></li>
                    <li><a href="Productos.php" target="myframe"><i class="fa fa-fw fa-tachometer-alt"></i> Productos</a></li>
                    <li><a href="https://bootadmin.net/demo"><i class="fa fa-fw fa-tachometer-alt"></i> Categorias de Productos</a></li>
                    <li><a href="https://bootadmin.net/demo"><i class="fa fa-fw fa-tachometer-alt"></i> Clientes </a></li>
                    <li><a href="https://bootadmin.net/demo"><i class="fa fa-fw fa-tachometer-alt"></i> Proveedores </a></li>
                    <li><a href="https://bootadmin.net/demo"><i class="fa fa-fw fa-tachometer-alt"></i> Clientes </a></li>
                    <li><a href="https://bootadmin.net/demo"><i class="fa fa-fw fa-tachometer-alt"></i> Distrito </a></li>
                    <li>
            ...
            <div class="content p-4">
                <iframe id="myframe" name="myframe"  style="display:"  class="iframe_principal" scrolling="si"  width="100%" height="800" frameborder="0" ></iframe>
