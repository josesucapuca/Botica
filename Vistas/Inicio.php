...
$Provee = $ProveedorDAO->SelectProveedor();
$Pres = $PresentacionDAO->ListarPresentacionDAO();
$Cat = $CategoriaDAO->ListarCategoriaDAO();
$Loc = $LocalDAO->ListarLocalDAO();
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control " name="Categoria" id="Categoria" required="">
                                        <option value="">Seleccionar</option>
                                        <?php
                                        while ($dataCat = $Cat->fetch_object()) {
                                            ?>
                                            <option value="<?php echo $dataCat->id_Categoria ?>"><?php echo $dataCat->No_Categoria ?></option>
                                        <?php } ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control " name="Presentacion" id="Presentacion" required="">
                                        <option value="">Seleccionar</option>
                                        <?php
                                        while ($dataPres = $Pres->fetch_object()) {
                                            ?>
                                            <option value="<?php echo $dataPres->id_Presentacion ?>"><?php echo $dataPres->No_Presentacion ?></option>
                                        <?php } ?>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control " name="Local" id="Local" required="">
                                        <option value="">Seleccionar</option>
                                        <?php
                                        while ($dataLoc = $Loc->fetch_object()) {
                                            ?>
                                            <option value="<?php echo $dataLoc->id_Local ?>"><?php echo $dataLoc->No_Local ?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control " name=Proveedor id="Proveedor" required="">
                                        <option value="">Seleccionar</option>
                                        <?php
                                        while ($dataProv = $Provee->fetch_object()) {
                                            ?>
